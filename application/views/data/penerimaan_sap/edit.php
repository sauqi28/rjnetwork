  ...
  <div class="page-content-tab">
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <form action="<?= site_url('data_user/edit/' . $user['id']); ?>" method="post">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control <?php echo (form_error('nip') != "") ? 'is-invalid' : ''; ?>" type="text" name="nip" value="<?= (set_value('nip') != "") ? set_value('nip') : $user['nip']; ?>" id="nip">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control <?php echo (form_error('username') != "") ? 'is-invalid' : ''; ?>" type="text" name="username" value="<?= (set_value('username') != "") ? set_value('username') : $user['username']; ?>" id="username">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control <?php echo (form_error('fullname') != "") ? 'is-invalid' : ''; ?>" type="text" name="fullname" value="<?= (set_value('fullname') != "") ? set_value('fullname') : $user['fullname']; ?>" id="fullname">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control <?php echo (form_error('email') != "") ? 'is-invalid' : ''; ?>" type="email" name="email" value="<?= (set_value('email') != "") ? set_value('email') : $user['email']; ?>" id="email">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-10">
                        <div class="input-group">
                          ...
                          <input class="form-control <?php echo (form_error('no_wa') != "") ? 'is-invalid' : ''; ?>" type="number" name="no_wa" value="<?= (set_value('no_wa') != "") ? set_value('no_wa') : $user['no_wa']; ?>" id="no_wa" placeholder="6281xxxxxxx">
                      ...
                      <div class="col-sm-10">
                        <select class="form-select <?php echo (form_error('position') != "") ? 'is-invalid' : ''; ?>" name="position" id="position">
                          <?php foreach ($user_positions as $position) : ?>
                            <option value="<?= $position->id ?>" <?= set_select('position', $position->id, $position->id == $user['position']); ?>><?= $position->position_name ?></option>
                          <?php endforeach; ?>
                        </select>
                      ...
                      <div class="col-sm-10">
                        <select class="form-select" name="role" id="role">
                          <?php foreach ($user_roles as $role) : ?>
                            <option value="<?= $role->id ?>" <?= set_select('role', $role->id, $role->id == $user['role']); ?>><?= $role->role_name ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
                      ...
                      <div class="col-sm-10">
                        <select class="form-select" name="kategori" id="kategori">
                          <?php foreach ($user_category as $kategori) : ?>
                            <option value="<?= $kategori->id ?>" <?= set_select('kategori', $kategori->id, $kategori->id == $user['category']); ?>><?= $kategori->category_name ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        // jika kategori user yang di-edit adalah External
        if (kategoriDropdown.val() == 2) {
          ...
          $.ajax({
            url: '<?= base_url('data_user/get_vendor_options'); ?>',
            method: 'POST',
            data: {
              kategori: kategoriDropdown.val(),
            ...
            success: function(data) {
              ...
              // set nilai default untuk pilihan vendor sesuai dengan data user yang di-edit
              pilihVendorDropdown.val(<?= $user['vendor'] ?>);

              // refresh plugin Bootstrap Select
              pilihVendorDropdown.selectpicker('refresh');
            }
          });
        }
