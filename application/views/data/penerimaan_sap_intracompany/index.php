  ...
  <div class="page-content-tab">
              ...
              <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent6">
                    ...
                    <form class="d-flex" method="get" action="<?php echo base_url('penerimaan_sap_intracompany/index'); ?>">
    ...
    <script>
      function showConfirmation(var1, var2) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.href = '<?php echo base_url('penerimaan_sap_intracompany/update_status/1/'); ?>' + var1;
          }
        });
      }
      ...
      function goView(var1) {
        window.location.href = '<?php echo base_url('penerimaan_sap_intracompany/view/'); ?>' + var1;
      }
    </script>
