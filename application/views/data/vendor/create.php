            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form action="<?= site_url('data_vendor/create'); ?>" method="post">
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">

                    <div class="mb-3 row">
                      <label for="nip" class="col-sm-2 col-form-label text-end">Nama Vendor</label>
                      <div class="col-sm-10">
                        <input placeholder="ex PT Mitra Abadi Jaya" class="form-control <?php echo (form_error('vendor_name') != "") ? 'is-invalid' : ''; ?>" type="text" name="vendor_name" value="<?= set_value('vendor_name'); ?>" id="vendor_name">
                    ...
                    <div class="mb-3 row">
                      <label for="vendor_address" class="col-sm-2 col-form-label text-end">Address</label>
                      <div class="col-sm-10">
                        <textarea class="form-control <?php echo (form_error('vendor_address') != "") ? 'is-invalid' : ''; ?>" name="vendor_address" id="vendor_address"><?= set_value('vendor_address'); ?></textarea>
                    ...
                    <div class="mb-3 row">
                      <div class="col-sm-10 offset-sm-2">
                        <input type="submit" value="Tambah Vendor" class="btn btn-primary">
                      </div>
                    </div>
                  </form>
