          ...
          <div class="card">
              ...
              <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent6">
                    ...
                    <form class="d-flex" method="get" action="<?php echo base_url('data_vendor/import_vendor'); ?>">
            ...
            <div class="card">
              <div class="card-header">
                <div class="alert custom-alert custom-alert-warning icon-custom-alert shadow-sm fade show" role="alert">
                  ...
                  <div class="alert-text my-1">
                    <h5 class="mb-1 fw-bold mt-0">Upload Data Vendor</h5>
                    <span>Halaman ini digunakan untuk upload data vendor secara massal, Download contoh file excel disini : <a href="<?php echo base_url('assets/files/file_vendor_mass_upload.xlsx'); ?>" style="color: blue;">file_vendor_mass_upload.xlsx</a></span>
                  </div>
              ...
              <div class="row">
                <div class="col-4">
                  <div class="card-body">
                    <form action="<?php echo base_url(); ?>data_vendor/import" method="post" enctype="multipart/form-data" form="myform">
                      <div class="input-group">
                ...
                <?php if (!$is_mst_vendors_temp_empty) : ?>
                  <div class="col-1">
                    <div class="card-body">
                      <form id="submit-form" action="<?php echo base_url(); ?>data_vendor/commit_data" method="post" enctype="multipart/form-data" form="myform">
                        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                  ...
                  <div class="col-1">
                    <div class="card-body">
                      <form id="reset-form" action="<?php echo base_url(); ?>data_vendor/reset_data" method="post" enctype="multipart/form-data" form="myform">
                        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                        <div class="button-items">
